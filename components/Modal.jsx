...
const Modal = ({ header, body1, body2, body3, footer, handleClose , image}) => {
    ...
    >
      <div ref={modalRef} className="w-2/5 md:w-11/12 minlg:w-2/4 dark:bg-nft-dark bg-white flex flex-col rounded-lg">
        ...
        <div className="flex p-10 sm:px-4 border-t border-b dark:border-nft-black-3 border-nft-gray-1">
          {body2}
          <div className='flex ml-10 my-[-8px] '>
            <Image src={images.connect} width={50} height={23}/>
          </div>
        </div>
        <div className=" flex p-10 sm:px-4 border-t border-b dark:border-nft-black-3 border-nft-gray-1">
          {body3}
          <div className='flex ml-10 my-[-12px] '>
            <Image src={images.coinbase} width={50} height={50}/>
          </div>
        </div>
